          ...
          <div className="flex space-x-3 space-x-reverse overflow-x-auto scrollbar-hide">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="flex-shrink-0 text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-muted rounded-full animate-pulse mb-2"></div>
        ...
        <div className="flex space-x-3 space-x-reverse overflow-x-auto pb-2 scrollbar-hide">
          ...
          <div className="flex-shrink-0 text-center">
            <div className="relative">
              <Avatar className="w-16 h-16 sm:w-20 sm:h-20 border-2 border-dashed border-muted-foreground">
                <AvatarImage src={user.avatar_url} />
                <AvatarFallback>{user.name?.charAt(0)}</AvatarFallback>
              </Avatar>
              <div className="absolute -bottom-0.5 -right-0.5 w-5 h-5 sm:w-6 sm:h-6 bg-primary rounded-full flex items-center justify-center">
                <Plus className="w-3 h-3 sm:w-4 sm:h-4 text-primary-foreground" />
              </div>
            </div>
            <p className="text-2xs sm:text-xs mt-1 truncate w-16 sm:w-20">
              إضافة
            </p>
          </div>
          ...
          {[
            ...
            >
              <div className="relative">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 p-0.5">
